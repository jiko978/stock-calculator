...
export const metadata: Metadata = {
    title: "주식 세금 계산기 | 국내/해외 주식 양도세 거래세 계산 - JIKO",
    description: "국내 코스피, 코스닥 거래세부터 해외 주식 양도소득세까지 정확하게 계산해 보세요. 수수료를 포함한 세후 순수익과 손해 보지 않는 최소 익절가를 즉시 확인하실 수 있습니다.",
    keywords: ["주식 세금 계산기", "증권거래세 계산", "해외주식 양도소득세 계산", "주식 수수료 계산", "최소 익절가", "주식 계산기"],
    alternates: { canonical: `${BASE_URL}/calculator/stock/tax` },
    openGraph: {
        title: "주식 세금 계산기 | JIKO",
        description: "세금 떼고 남는 진짜 내 수익은 얼마일까? 해외주식 250만원 공제 완벽 반영!",
        url: `${BASE_URL}/calculator/stock/tax`,
...
export default function Page() {
    ...
    return (
        <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
            ...
            <NavBar title="주식 세금 계산기" description="주식 매도 시 발생하는 세금과 수수료를 계산해보세요" position="top" />
            <StockTax />
